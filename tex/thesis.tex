...
%\include{chaps/template}        %テンプレート
\include{chaps/introduction}	%１章　序論
\include{chaps/relatedwork}		%２章　関連研究
\include{chaps/knowledge}		%３章　周辺知識
\include{chaps/experiment}		%４章　予備実験
%\include{chaps/basicmethod}     %５章　本手法の基礎技術
\include{chaps/method}			%６章　提案手法
\include{chaps/result}			%７章　結果と考察
\include{chaps/conclusion}		%８章　結論
\include{chaps/artfesta}        %応用事例
